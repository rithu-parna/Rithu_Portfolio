...
// Animation variants for the text section of the card
const textVariants = {
...
// Animation variants for the image section of the card
const imageVariants = {
  hidden: { opacity: 0, x: 50 },
  visible: {
    opacity: 1,
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        sx={{
          width: { xs: "100%", md: "50%" },
          borderTopRightRadius: isReverse ? 0 : 3,
          borderBottomRightRadius: isReverse ? 0 : 3,
          borderTopLeftRadius: isReverse ? 3 : 0,
          borderBottomLeftRadius: isReverse ? 3 : 0,
          height: "469px",
          objectFit: "cover",
          WebkitMaskImage: {
            xs: "linear-gradient(to right, rgba(0,0,0,0.2), rgba(0,0,0,1))",
            sm: "linear-gradient(to right, rgba(0,0,0,0.2), rgba(0,0,0,1))",
            md: `linear-gradient(to ${
...
const RealTimeCollabCard = () => {
  const projects = [
    {
      title: "Supply Chain Management (CRM)",
      description:
        "Designed a CRM system from scratch for supply chain management.",
      imageSrc: LogisticImg,
      implementation: [
        "Built a support module with integrated ticketing system.",
        "Built service booking tabs for approvals and data entry.",
        "Built billing modules for transactions and invoicing.",
        "Handled user create, update, suspend, and reset.",
      ],
      direction: "normal",
    },
    {
      title: "Wateron",
      description:
        "Designed frontend for admin billing to generate flat-wise water bills.",
      imageSrc: SmarterHomes,
      implementation: [
        "UI to monitor apartment-wise water usage & status",
        "Valve control interface to manage water supply per flat",
        "Forms&tables to view & edit apartment data.",
        "Billing screen to generate water bills based on usage.",
      ],
      direction: "reverse",
    },
    {
      title: "Savitha Jewellery Website",
      description:
        "Complete design of a modern showcase website for a luxury jewelry brand.",
      imageSrc: Jwellery,
      implementation: [
        "Designed the entire UI from scratch.",
        "Created a premium, elegant showcase for jewelry collections.",
        "Highlighted product photography with clean design.",
        "Focused on minimal aesthetics and responsive layouts.",
      ],
      direction: "normal",
    },
  ];
  ...
  return (
    <Box sx={{ background: "#161b22", mt: -10, pb: 10 }}>
      <Typography
        ...
        initial="hidden"
        whileInView="visible"
        // Change 'once: true' to 'once: false' here as well for the title
